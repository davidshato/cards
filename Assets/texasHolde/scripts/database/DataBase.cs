...
public class DataBase 
{
    ...
    private const string datasource = " 192.168.43.126"; //192.168.1.102
    private const string myusername = "connect";// "connect";
	private const string port = "3306";
    private const string pass = "1234";//"1234";
    ...
    }//execute the insert update and delete function claas use in this func Register
	...
	protected DataSet GetMultipleQuary(MySqlCommand cmd)
	{
		...
		return dataset;
    }//function for the select queries- claas use in thus func LOGIN
}
